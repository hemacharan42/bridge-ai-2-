...
function createInitialData(): BackendStore {
  return {
    ...
    candidates: [
      ...
      {
        candidate_id: "STUDENT_ITI_UP_2026_088",
        student_id: "ITI-UP-2026-088",
        name: "Pooja Sharma",
        avatar_url: "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=150&auto=format&fit=crop&q=80",
        trade: "Solar PV Rooftop Technician",
        institution: "Govt ITI Alambagh Lucknow",
        composite_score: 92.4,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-5542-AUTH",
        verified_clip_duration: "4.1s MPPT synchronization verified",
        hiring_status: "Shortlisted by Tata Power Solar",
        safety_score: 97,
        practical_speed_rank: "Top 7%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 4,
        viva_speech_score: 92,
        procedural_score: 93,
        uncertainty_rate: 1.0,
        video_drills_count: 4,
        key_skills: ["Grid Tie Sync", "Voc/Isc Testing", "Double Insulated MC4", "Earthing Mat Resistance"],
        task_execution_time: "29 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_WB_2026_145",
        student_id: "ITI-WB-2026-145",
        ...
        trade: "CNC Machinist NSQF Level 5",
        institution: "Govt ITI Gariahat Kolkata",
        composite_score: 95.8,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-3199-AUTH",
        verified_clip_duration: "G-Code dry run & 5-micron zeroing",
        hiring_status: "Available for Immediate Plant Hire",
        safety_score: 99,
        practical_speed_rank: "Top 3%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 5,
        viva_speech_score: 94,
        procedural_score: 97,
        uncertainty_rate: 0.5,
        video_drills_count: 5,
        key_skills: ["Fanuc 0i-MF Control", "Dial Indicator Alignment", "Coolant Flow Interlock", "Micrometer Tolerance"],
        task_execution_time: "24 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_PB_2026_077",
        student_id: "ITI-PB-2026-077",
        name: "Gurpreet Singh",
        avatar_url: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150&auto=format&fit=crop&q=80",
        trade: "Industrial Refrigeration & HVAC L4",
        institution: "Govt ITI Ludhiana Central",
        composite_score: 88.6,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-4401-AUTH",
        verified_clip_duration: "Nitrogen pressure holding test passed",
        hiring_status: "Available for Immediate Plant Hire",
        safety_score: 93,
        practical_speed_rank: "Top 14%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 4,
        viva_speech_score: 87,
        procedural_score: 89,
        uncertainty_rate: 2.1,
        video_drills_count: 3,
        key_skills: ["R-410A Recovery Unit", "Manifold Gauge Evacuation", "Brazing Nitrogen Purge", "Compressor Megger Test"],
        task_execution_time: "38 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_TS_2026_198",
        student_id: "ITI-TS-2026-198",
        name: "Meera Reddy",
        avatar_url: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80",
        trade: "Automation & PLC Wireman L5",
        institution: "Govt ITI Mallepally Hyderabad",
        composite_score: 96.5,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-1029-AUTH",
        verified_clip_duration: "Safety Relay SIL-3 loop certified",
        hiring_status: "Shortlisted by L&T Heavy Tech",
        safety_score: 98,
        practical_speed_rank: "Top 2%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 5,
        viva_speech_score: 96,
        procedural_score: 96,
        uncertainty_rate: 0.8,
        video_drills_count: 4,
        key_skills: ["E-Stop Dual Channel", "PLC Modbus TCP/IP", "4-20mA Pressure Transmitter", "ESD Mat Grounding"],
        task_execution_time: "25 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_KL_2026_064",
        student_id: "ITI-KL-2026-064",
        name: "Rahul Menon",
        avatar_url: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=150&auto=format&fit=crop&q=80",
        trade: "Electrician NSQF Level 4",
        institution: "Govt ITI Kalamassery Kochi",
        composite_score: 90.7,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-8172-AUTH",
        verified_clip_duration: "3.8s busbar torque check verified",
        hiring_status: "Available for Immediate Plant Hire",
        safety_score: 94,
        practical_speed_rank: "Top 9%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 4,
        viva_speech_score: 91,
        procedural_score: 90,
        uncertainty_rate: 1.6,
        video_drills_count: 3,
        key_skills: ["Phase Sequence Indicator", "Insulation Resistance >100MΩ", "Shrink Sleeve Heatgun", "IP65 Enclosure Gasket"],
        task_execution_time: "31 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_OD_2026_221",
        student_id: "ITI-OD-2026-221",
        ...
        trade: "EV Battery Service NSQF L5",
        institution: "Govt ITI Cuttack Industrial",
        composite_score: 85.9,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-6703-AUTH",
        verified_clip_duration: "Pack isolation resistance verified",
        hiring_status: "Available for Immediate Plant Hire",
        safety_score: 90,
        practical_speed_rank: "Top 18%",
        project_upload_tier: "Silver Tier (2 Drills)",
        nsqf_level: 5,
        viva_speech_score: 85,
        procedural_score: 87,
        uncertainty_rate: 2.8,
        video_drills_count: 2,
        key_skills: ["HV Contactor Diagnostics", "Thermal Runaway Venting", "CAN Bus Sniffer", "Insulated Spanner 1000V"],
        task_execution_time: "43 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_MH_2026_334",
        student_id: "ITI-MH-2026-334",
        name: "Ananya Joshi",
        avatar_url: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
        trade: "Electronics System Design L5",
        institution: "Govt ITI Aundh Pune",
        composite_score: 95.2,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-9912-AUTH",
        verified_clip_duration: "SMD rework & thermal profile certified",
        hiring_status: "Shortlisted by Bharat Electronics",
        safety_score: 98,
        practical_speed_rank: "Top 4%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 5,
        viva_speech_score: 95,
        procedural_score: 95,
        uncertainty_rate: 0.7,
        video_drills_count: 5,
        key_skills: ["SMD Hot Air Rework", "ESD Wristband Grounding", "Oscilloscope Waveform", "IPC-A-610 Standard"],
        task_execution_time: "26 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_MP_2026_091",
        student_id: "ITI-MP-2026-091",
        name: "Rohan Verma",
        avatar_url: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80",
        trade: "Automation & PLC Wireman L5",
        institution: "Govt ITI Indore Nanda Nagar",
        composite_score: 92.8,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-3482-AUTH",
        verified_clip_duration: "SCADA Tagging & VFD loop verified",
        hiring_status: "Available for Immediate Plant Hire",
        safety_score: 96,
        practical_speed_rank: "Top 6%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 5,
        viva_speech_score: 92,
        procedural_score: 93,
        uncertainty_rate: 1.1,
        video_drills_count: 4,
        key_skills: ["VFD Speed Ramp Setup", "RS-485 Modbus Loop", "Shielded Twisted Pair Ground", "E-Stop Safety Contactor"],
        task_execution_time: "27 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_BR_2026_167",
        student_id: "ITI-BR-2026-167",
        name: "Sunil Paswan",
        avatar_url: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80",
        trade: "Electrician NSQF Level 4",
        institution: "Govt ITI Digha Ghat Patna",
        composite_score: 89.9,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-7810-AUTH",
        verified_clip_duration: "Earth pit resistance < 1.0 ohm verified",
        hiring_status: "Available for Immediate Plant Hire",
        safety_score: 95,
        practical_speed_rank: "Top 11%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 4,
        viva_speech_score: 88,
        procedural_score: 91,
        ...
        video_drills_count: 3,
        key_skills: ["Earth Electrode Testing", "4-Pole Earth Tester", "Bentonite Salt-Charcoal Mix", "Megger Continuity Test"],
        task_execution_time: "33 seconds"
      },
      {
        candidate_id: "STUDENT_ITI_HR_2026_052",
        student_id: "ITI-HR-2026-052",
        name: "Kavita Yadav",
        avatar_url: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80",
        trade: "EV Battery Service NSQF L5",
        institution: "Govt ITI Gurugram Sector 14",
        composite_score: 94.1,
        verdict: "CERTIFIED_COMPETENT",
        verified_badge: "SB-NSQF-2026-8809-AUTH",
        verified_clip_duration: "HV battery module torque sequence verified",
        hiring_status: "Shortlisted by Maruti Suzuki EV",
        safety_score: 97,
        practical_speed_rank: "Top 5%",
        project_upload_tier: "Gold Tier (3+ Drills)",
        nsqf_level: 5,
        ...
        uncertainty_rate: 0.9,
        video_drills_count: 4,
        key_skills: ["Insulated Torque 12Nm", "Pyrofuse Safety Check", "Thermistor NTC Validation", "HVIL Jumper Continuity"],
        task_execution_time: "26 seconds"
      }
    ],
